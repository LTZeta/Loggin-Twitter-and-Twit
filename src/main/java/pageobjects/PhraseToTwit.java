...
public class PhraseToTwit extends AbstractPage{
    ...
    private final static By chooseAudienceCircle = By.xpath("//div[@class='css-1dbjc4n r-1awozwy r-1loqt21 r-18u37iz r-1ny4l3l r-ymttw5 r-1f1sjgu r-o7ynqc r-6416eg r-13qz1uu']");
    ...
    public void twitThis (String phrase, int audience){
        ...
        if (audience == 2){
            ...
            getWait().until(ExpectedConditions.visibilityOfElementLocated(chooseAudienceCircle));
            List<WebElement> webElementList = getDriver().findElements(chooseAudienceCircle);
